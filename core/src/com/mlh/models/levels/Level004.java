...
public class Level004 extends Level {
    ...
    private static final Class NEXT_LEVEL = Level005.class;
    private static final int WORD_LENGTH = HMSDreadnought.wordLength + 3;
