 ...
 * @author michael
 */
public class Fighter extends EnemyActor {

    // first boss
    private static final String NAME = "Fighter";
    private static final int SCORE_VALUE = 100;

    private boolean enter = true;

    public Fighter(World world, Player player, PhraseManager phraseManager, int phraseLength, String phraseLetters) {
        super(world, NAME, player, phraseManager, phraseLength, phraseLetters);
    }

    @Override
    public void init(int drawLayer) {
        String SHIP_FILE = "core/assets/data/ships/Fighter.shp";
