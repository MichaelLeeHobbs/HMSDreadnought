 ...
 * @author michael
 */
public class SongBird extends EnemyActor {

    // first boss
    private static final String NAME = "SongBird";
    private static final int SCORE_VALUE = 200;

    private boolean enter = true;

    public SongBird(World world, Player player, PhraseManager phraseManager, int phraseLength, String phraseLetters) {
        super(world, NAME, player, phraseManager, phraseLength, phraseLetters);
    }

    @Override
    public void init(int drawLayer) {
        String SHIP_FILE = "core/assets/data/ships/Songbird.shp";
