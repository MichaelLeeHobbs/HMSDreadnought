 ...
 * @author michael
 */
public class KnifeEdge extends EnemyActor implements IPhraseCollidable {

    // first boss
    private static final String NAME = "Knife Edge";
    private static final String SHIP_FILE = "core/assets/data/ships/Knife_Edge.shp";
    private static final int SCORE_VALUE = 10000;

    private boolean init = true;
    private boolean enter = false;

    public KnifeEdge(World world, Player player, PhraseManager phraseManager, int phraseLength, String phraseLetters) {
        super(world, NAME, player, phraseManager, phraseLength, phraseLetters);

        // death animation
        TEXTURE_FILE = "core/assets/textures/explosion3x3.png";
