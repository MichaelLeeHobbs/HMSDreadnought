 ...
 * @author michael
 */
public class Bat extends EnemyActor {
    ...
    public Bat(World world, Player player, PhraseManager phraseManager, int phraseLength, String phraseLetters) {
        super(world, NAME, player, phraseManager, phraseLength, phraseLetters);
    }

    @Override
    public void init(int drawLayer) {
        String SHIP_FILE = "core/assets/data/ships/Bat.shp";
